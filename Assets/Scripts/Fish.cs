...
public class Fish : MonoBehaviour
{
    ...
    public void Start()
    {
        if(fishNameText != null)fishNameText.SetText(animalName);
    }
    ...
    {
        if((rightSide && collision.gameObject.tag == "Left Collider")|| (!rightSide && collision.gameObject.tag=="Right Collider")) Death();       
    }
